...
## ----load_raster_data----------------------------------------------------
data_loc <- file.path(getwd(),"analysis","data","raw_data","clip_raster")
...
## ----mapview_weights-----------------------------------------------------
mapview(model_sum, col.regions = viridisLite::viridis, alpha = 0.95, maxpixels =  897336) +
  mapview(sites_sum, col.regions = viridisLite::magma, maxpixels =  897336, alpha = 0.75)
